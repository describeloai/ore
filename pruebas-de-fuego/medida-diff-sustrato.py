...
print()
print("   `ore diff` no lee `kind: View` ni `kind: Table`: no aparecen en")
print("   `diff.rs` ni una vez, y caen en el `_ => {}` del despacho. Los dos")
print("   codigos que protegian esto -`OOS5019` binding fisico cambiado y")
print("   `OOS5020` modo de materializacion cambiado- se calculan sobre")
print("   `Kind::Binding`, que v1alpha8 retiro. En el paradigma actual no")
print("   pueden dispararse por ningun documento.")
