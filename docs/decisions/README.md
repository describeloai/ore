...
| [0034](0034-el-catalogo-de-assets.md) · el catálogo de assets | el Assets Catalog **es el registro del inquilino y el registro es el árbol**: lee, no autora; los **ítems** (Dataset, Table, View, Entity, Interface, Concept, Function, Action, modelo entrenado y servido) y las **capas** que se ven encima (access, rules, links, history); database = paquete, schema = carpeta del paquete; sólo lo respaldado, medido ítem a ítem antes de pintar | **propuesto** · sin medir |
