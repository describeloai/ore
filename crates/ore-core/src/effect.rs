...
mod tests {
    ...
    // La prueba de que `OOS7013` se disparaba vivia aqui, y se fue con su
    // cableado: el ADR 0018 lo reservo, porque escribir aterriza en la copia
    // —que guarda el vocabulario de la vista— y un edit cae DENTRO de `Q`.
    //
    // Lo que NO se fue es la maquina: `vistas::invertible` y su censo siguen
